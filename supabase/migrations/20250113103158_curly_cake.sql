...
INSERT INTO messages (telegram_user_id, content, type, status, created_at)
SELECT 
  telegram_user_id,
  message,
  CASE 
...
INSERT INTO messages (telegram_user_id, content, type, status, created_at, error_message)
SELECT 
  telegram_user_id,
  message,
  'admin'::message_type,
